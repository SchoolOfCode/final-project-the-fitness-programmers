    ...
    <div className='flex flex-col justify-between mb-10'>
      ...
      >
        ...
        <div className='w-full flex justify-center'>
          <button
            type='submit'
            className='group relative w-full max-w-md py-2 px-4 border border-transparent text-sm font-bold text-main rounded-full bg-primaryColour hover:bg-teal-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-400 mt-8'
          >
            Submit
          </button>
        </div>
